...
private:
    ...
    static constexpr short ads1118_typek_table[22][2] PROGMEM = {
        ...
        { ADS1118_mV_TO_STEP( 3.1838),  78 },
        { ADS1118_mV_TO_STEP( 4.1373), 101 },
        { ADS1118_mV_TO_STEP( 5.0832), 124 },
        { ADS1118_mV_TO_STEP( 6.0171), 147 },
        { ADS1118_mV_TO_STEP( 6.9410), 170 },
        { ADS1118_mV_TO_STEP( 7.8587), 193 },
        { ADS1118_mV_TO_STEP( 8.7796), 216 },
        { ADS1118_mV_TO_STEP( 9.7066), 239 },
        { ADS1118_mV_TO_STEP(10.6430), 262 },
        { ADS1118_mV_TO_STEP(11.5885), 285 },
        { ADS1118_mV_TO_STEP(12.5410), 308 },
        { ADS1118_mV_TO_STEP(13.4987), 331 },
        { ADS1118_mV_TO_STEP(14.4610), 354 },
        { ADS1118_mV_TO_STEP(15.4277), 377 },
